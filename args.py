...
def get_parser():
    ...
    # data
    parser.add_argument('--final_img_path', default='../../finalImages_finetune/')
    parser.add_argument('--final_img_ori_path', default='/home/pku1616/FoodRecipe/detail_spider/FoodImages')
    parser.add_argument('--final_img_verb_path', default='../../finalImages_finetune_verb/')
    parser.add_argument('--step_img_path', default='../../StepImages_finetune_group_80/')
    parser.add_argument('--recipe_path', default='../../recipe_feat_new/')

    parser.add_argument('--train_lis', default='../../data_90/train_lis.pkl')
    parser.add_argument('--valid_lis', default='../../data_90/valid_lis.pkl')
    parser.add_argument('--test_lis', default='../../data_90/test_lis.pkl')
    parser.add_argument('--test_lis_split', default='../../data_90/test_lis_split.pkl')
    parser.add_argument('--classes', default='../../data_90/class.pkl')

    parser.add_argument('--VireoFood172', default='../../data_90/VireoFood172_finetune_path_list.pkl')
    parser.add_argument('--recipe_dict', default='../../data_90/recipeDict.pkl')
    parser.add_argument('--name_dict', default='../../data_90/nameDict.pkl')
    parser.add_argument('--word_mat', default='../../data_90/word_mat.npy')
