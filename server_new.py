...
food_dict = pkl.load(open('/home/ubuntu/linyang/APP_new/food_dict_new2.pkl', 'rb'))
ids = pkl.load(open('/home/ubuntu/linyang/APP_new/rec_ids.pkl', 'rb'))
rec_emb = np.load('/home/ubuntu/linyang/APP_new/rec_emb.npy')
...
Model.load_state_dict(torch.load('/home/ubuntu/linyang/APP_new/model_statedict_globatt.pth', map_location='cpu'))
Model.eval()
...
class UploadFileHandler(BaseHandler):
	...
	def post(self):
		upload_path=os.path.join('/home/ubuntu/linyang/APP_new','tmp_files')
